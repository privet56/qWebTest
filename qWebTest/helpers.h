...
public:
    ...
    static int copydirifdifferent(QString sFrom,QString sTo,QString sPattern, bool bWarnIfNotFound, QApplication* pApp, QObject* pLogTarget);
    ...
    static int copydirifdifferent(QString sFr, QString sTo, QApplication* pApp, QObject* pLogTarget);
    ...
    static bool str_isnum(QString s, bool bCanHaveDot, bool bCanBeNegative);
