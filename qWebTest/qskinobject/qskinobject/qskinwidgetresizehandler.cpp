...
#define RANGE 4
#ifdef WIN32
//#include <QtWidgets/private/qlayoutengine_p.h>
#include <QtWidgets/5.2.1/QtWidgets/private/qlayoutengine_p.h>
#else
...
bool QSkinWidgetResizeHandler::eventFilter(QObject *o, QEvent *ee)
{
    ...
    case QEvent::MouseButtonRelease:
	    ...
	    obj->mouseReleaseEvent(static_cast<QMouseEvent*>(ee));
        if (w->isMaximized())
            break;
        if (e->button() == Qt::LeftButton) {
